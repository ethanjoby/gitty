      ...
      <main className="sign-in-main">
        <section className="sign-in-card">
          <div className="sign-in-wordmark">
            ...
            <span className="sign-in-wordmark-sub">for companies</span>
          </div>

          <h1 className="sign-in-heading">Sign in to continue</h1>
          <p className="sign-in-copy">
            Google OAuth is used to identify your company account. Manage roles, track applicants, and post bounties.
          </p>
          ...
          <button className="sign-in-oauth-btn" onClick={handleGoogleSignIn}>
            <svg className="sign-in-oauth-icon" viewBox="0 0 24 24" aria-hidden="true">
